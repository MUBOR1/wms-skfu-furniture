...
import { Package, AlertTriangle, TrendingUp, FileText, Search, XCircle as XIcon, DollarSign, Wallet, Percent, Calendar, RefreshCw } from 'lucide-react'
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          <TrendingUp className="w-7 h-7 text-indigo-600" /> Аналитика склада
        </h2>
          ...
          <ResponsiveContainer width="100%" height={280}>
            <PieChart>
              <Pie 
                ...
                outerRadius={80} 
                innerRadius={40}
                // 🔧 ИСПРАВЛЕНО: правильные типы для label
      ...
      {/* 🔧 КАРТОЧКИ СТАТУСОВ ОСТАТКОВ - МЯГКОЕ ВЫДЕЛЕНИЕ */}
